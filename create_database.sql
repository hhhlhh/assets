...
CREATE TABLE fixed_assets (
    ...
    asset_code VARCHAR(50) UNIQUE COMMENT '资产编号',
...
INSERT INTO fixed_assets (
    asset_code, asset_name, asset_category, classification_name,
    original_value, net_value, department, user_name, location,
    specification, start_date, responsible_person, asset_status
) VALUES
('FA001', '联想台式电脑', '电子设备', '计算机设备', 5000.00, 4500.00,
 '技术部', '张三', '办公室A-101', 'ThinkCentre M720', '2023-01-15', '张三', '在用'),
('FA002', '佳能打印机', '办公设备', '打印设备', 2000.00, 1800.00,
 '行政部', '李四', '办公室B-201', 'Canon LBP2900', '2023-02-20', '李四', '在用'),
('FA003', '办公桌椅', '办公家具', '桌椅类', 1500.00, 1200.00,
 '财务部', '王五', '办公室C-301', '实木办公桌', '2022-12-10', '王五', '在用');
